...
Install Payload Editor with exactly matched Payload Lexical peers.

**Topic:** installation
**Package:** `@nexload-sdk/payload-editor` v1.1.0
**Canonical page:** https://gecut.github.io/nexload-sdk/packages/payload-editor/installation/
```bash
