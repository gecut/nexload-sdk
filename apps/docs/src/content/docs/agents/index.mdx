---
title: Agent skills
description: Repository-wide engineering standards and package-scoped guidance for coding agents working with Nexload SDK.
sidebar:
  order: 1
topic: agents
---
...
<CardGrid>
  <Card title="Nexload engineering standards" icon="puzzle">
  ...
  <Card title="Nexload CTO review" icon="puzzle">
  ...
  <Card title="Payload Operations skills" icon="document">
...
<CardGrid>
  <DocLinkCard
    ...
    href="/agents/install/"
    description="Use the official skills CLI with this public repository."
  />
  <DocLinkCard
    title="Healthcheck docs"
    href="/packages/healthcheck/"
    description="Read the runtime and security contract behind the Healthcheck Skills."
  />
  <DocLinkCard
    title="Payload Fields docs"
    href="/packages/payload-fields/"
    description="Read the persistence and Admin contract behind the Payload Skills."
  />
  <DocLinkCard
    title="Payload Editor docs"
    href="/packages/payload-editor/"
    description="Read the semantic editor and native extension contracts."
  />
  <DocLinkCard
    title="Payload Schema docs"
    href="/packages/payload-schema/"
    description="Read the canonical field, Payload adapter, and Zod derivation contracts."
  />
  <DocLinkCard
    title="Payload Operations docs"
    href="/packages/payload-operations/"
    description="Read the contract, client transport, endpoint, access, and error boundaries."
  />
</CardGrid>
