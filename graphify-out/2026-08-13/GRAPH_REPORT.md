...
## Corpus Check
- 670 files · ~150,181 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3580 nodes · 4421 edges · 442 communities (296 shown, 146 thin omitted)
...
- scripts
- Payload Operation Errors
- CMS Operation Traversal
- Environment Manager
...
- devDependencies
- manager.ts
- CMS Operation Response
- Payload Endpoint Logic
...
## Communities (442 total, 146 thin omitted)
...
### Community 5 - "Nexload Logger Implementation"
Cohesion: 0.10
...
Cohesion: 0.12
Nodes (17): eslint-config-prettier, @eslint/js, eslint-plugin-only-warn, eslint-plugin-react-hooks, globals, @stylistic/eslint-plugin, dependencies, eslint-config-prettier (+9 more)
...
### Community 18 - "CMS Client Factory"
Cohesion: 0.18
...
### Community 24 - "Operation Request Handling"
Cohesion: 0.19
...
### Community 26 - "Payload Operation Errors"
Cohesion: 0.15
...
### Community 27 - "CMS Operation Traversal"
Cohesion: 0.18
...
### Community 32 - "Next.js Health Routes"
Cohesion: 0.17
...
Cohesion: 0.13
Nodes (18): memoryCheck(), runtimeInfoCheck(), shutdownCheck(), startupCheck(), timerLagCheck(), runtimeMetricsCollector(), defineHealthCheck(), defineMetricCollector() (+10 more)

### Community 41 - "core/types.ts"
Cohesion: 0.14
...
Cohesion: 0.17
Nodes (17): ALLOWED_FRONTMATTER, DEPRECATED_NAMES, EVAL_CATEGORIES, FOUNDATIONAL_NEXLOAD_SKILLS, lineCount(), parseFrontmatter(), parseJson(), parseScalar() (+9 more)
...
### Community 57 - "CMS Operation Response"
Cohesion: 0.25
...
### Community 58 - "Payload Endpoint Logic"
Cohesion: 0.27
...
### Community 74 - "Operation Contract Types"
Cohesion: 0.29
...
### Community 80 - "Payload Healthcheck Logic"
Cohesion: 0.20
...
Cohesion: 0.10
Nodes (19): devDependencies, @nexload-sdk/eslint-config, @nexload-sdk/logger, @nexload-sdk/typescript-config, typescript, vite, @nexload-sdk/eslint-config, @nexload-sdk/logger (+11 more)

### Community 101 - "Dependency Update Configuration"
Cohesion: 0.22
...
Cohesion: 0.50
Nodes (4): Exporter Contracts, Metric Names and Labels, Verification, Healthcheck Monitoring Exporters

### Community 153 - "Payload Healthcheck Integration"
Cohesion: 0.50
...
Cohesion: 0.50
Nodes (4): Payload Compatibility, Release Validation, Semantic Contract, Payload Editor Core

### Community 157 - "Payload Editor Extensions"
Cohesion: 0.50
Nodes (4): Blocks and Client Features, Collision Diagnosis, Native Seam, Payload Editor Extensions

### Community 158 - "Payload Editor Presets"
Cohesion: 0.50
Nodes (4): Override Rules, Preset Matrix, Preset Versioning, Payload Editor Presets

### Community 159 - "Payload Fields Core"
Cohesion: 0.50
Nodes (4): Factory Contracts, Migration and Validation, Overrides and Import Map, Payload Fields Core

### Community 160 - "Jalali Date Skills"
Cohesion: 0.50
...
Cohesion: 0.50
Nodes (4): Client Construction, Response Handling, Transport Pipeline, Payload Operations Client

### Community 163 - "Payload Operations Core"
Cohesion: 0.50
Nodes (4): Contract Model, Error Model, Package Boundaries, Payload Operations Core

### Community 164 - "Payload Operations Server"
Cohesion: 0.50
...
Cohesion: 0.20
Nodes (9): 2.0.0, 2.0.1, 2.1.0, Major Changes, Minor Changes, @nexload-sdk/healthcheck-bun, Patch Changes, Patch Changes (+1 more)

### Community 348 - "@nexload-sdk/healthcheck-next"
Cohesion: 0.20
Nodes (9): 2.0.0, 2.0.1, 2.1.0, Major Changes, Minor Changes, @nexload-sdk/healthcheck-next, Patch Changes, Patch Changes (+1 more)

### Community 349 - "@nexload-sdk/healthcheck-node"
Cohesion: 0.20
Nodes (9): 2.0.0, 2.0.1, 2.1.0, Major Changes, Minor Changes, @nexload-sdk/healthcheck-node, Patch Changes, Patch Changes (+1 more)

### Community 350 - "@nexload-sdk/healthcheck-otel"
Cohesion: 0.20
...
Cohesion: 0.22
Nodes (9): import, require, types, exports, ./admin/slug-field, ./slug, import, require (+1 more)
...
### Community 389 - "./admin/jalali-date-cell"
Cohesion: 0.50
Nodes (4): import, require, types, ./admin/jalali-date-cell
...
## Knowledge Gaps
- **1792 isolated node(s):** `$schema`, `changelog`, `commit`, `fixed`, `linked` (+1787 more)
...
- **Why does `devDependencies` connect `devDependencies` to `payload-schema/package.json`, `peerDependencies`, `@types/node`, `@payloadcms/next`, `eslint`?**
